...
cran_updates_btw <- round(cran_updates_btw, digits = 0)
```
...
# warnings are issued if "date: today" or "date-modified: today"
# used in contents pages
...
r4p_postbtw <- as.numeric(today - min_date) / nrow(r4p_posts.df)
r4p_postbtw <- round(r4p_postbtw, digits = 0)
```
...
photo_postbtw <- as.numeric(today - min_date) / nrow(photo_posts.df)
photo_postbtw <- round(photo_postbtw, digits = 0)
```
